...
read_remindPolicy <- function(remind_run,remind_path, remind_path_base, isDisplay = TRUE, isExport = TRUE){
  ...
  #for later ease of use rename the scenarios
  scens <- getScenarios(remind_data)
  # the NPi-CCimp should be treated as a policy scenario (comparing it to the no-impact NPi)
  #TODO added "CP" to list of identifiers of reference/base scenario for tests on ELEVATE scenarios. keep this?
